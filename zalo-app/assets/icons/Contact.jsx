...
const Contact = (props) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color="#4a90e2" fill="none" {...props}>
    ...
    <Path d="M8 4V2" stroke="currentColor" strokeWidth={props.strokeWidth} strokeLinecap="round" />
    <Path d="M16 4V2" stroke="currentColor" strokeWidth={props.strokeWidth} strokeLinecap="round" />
