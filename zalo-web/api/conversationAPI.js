...
export const getConversationsGroup = async (userId) => {
  try {
    const res = await api.get(
      BACKEND_URL + `/api/conversations/group/${userId}`
    );
    return { success: true, data: res.data };
  } catch (error) {
...
export const getConversation = async (conversationId) => {
  try {
    const res = await api.get(
      BACKEND_URL + `/api/conversations/conversationId/${conversationId}`
    );
    return { success: true, data: res.data };
  } catch (error) {
...
export const getConversationBetweenTwoUsers = async (friend_id, user_id) => {
  try {
    const res = await api.get(
      BACKEND_URL +
        `/api/conversations/get-conversation1vs1/${friend_id}/${user_id}`
    );
    return { success: true, data: res.data };
  } catch (error) {
    return handleApiError(error);
...
export const createConversation1vs1 = async (userId, friendId) => {
  try {
    if (!userId || !friendId) {
      return {
        success: false,
        data: { message: "userId và friendId là bắt buộc" },
      };
    }

    const response = await api.post(
      BACKEND_URL + `/api/conversations/create1vs1`,
      {
        user1: userId,
        user2: friendId,
      }
...
export const createConversationGroupChat = async (groupData) => {
  try {
    if (!groupData.admin || groupData.members.length < 2) {
      return {
        success: false,
        data: { message: "Có thể chưa đủ số lượng thành viên tối thiểu!" },
      };
    }

    const response = await api.post(
      BACKEND_URL + "/api/conversations/createGroup",
      {
...
export const deleteConversation1vs1 = async (conversationId, userId) => {
  try {
    const response = await api.patch(
      BACKEND_URL + `/api/conversations/${conversationId}/delete/${userId}`
    );
    return { success: true, data: response.data };
  } catch (error) {
...
export const changeAdminGroup = async (conversationId, newAdminId) => {
  try {
    const response = await api.patch(
      BACKEND_URL + `/api/conversations/${conversationId}/change-admin`,
      { newAdminId }
    );
    return { success: true, data: response.data };
  } catch (error) {
...
export const updateAvataConversation = async (conversationId, avatar) => {
  try {
    const response = await api.patch(
      BACKEND_URL + `/api/conversations/${conversationId}/avatar`,
      { avatar }
    );
    return { success: true, data: response.data };
  } catch (error) {
...
export const addMemberToGroup = async (
  ...
  try {
    const response = await api.patch(
      BACKEND_URL + `/api/conversations/${conversationId}/add-member`,
      { newMembers, userRequest }
    );
    return { success: true, data: response.data };
  } catch (error) {
...
export const removeMemberFromGroup = async (
  ...
  try {
    const response = await api.patch(
      BACKEND_URL + `/api/conversations/${conversationId}/remove-member`,
      { memberId, userRequest }
    );
    return { success: true, data: response.data };
  } catch (error) {
...
export const changeSettingApproved = async (converId) => {
  try {
    const response = await api.patch(
      BACKEND_URL + `/api/conversations/${converId}/change-approved`
    );
    return { success: true, data: response.data };
  } catch (error) {
...
export const handleApprovedRequest = async (
  conversationId,
  memberId,
  userRequest,
  action
  ...
  try {
    const response = await api.patch(
      BACKEND_URL + `/api/conversations/${conversationId}/handle-request`,
      { memberId, userRequest, action }
    );
    return { success: true, data: response.data };
  } catch (error) {
