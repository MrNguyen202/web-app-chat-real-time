...
//           // Khi nhận được sự kiện PASSWORD_RECOVERY, chuyển hướng đến ResetPassword
//           const urlParams = new URLSearchParams(
//             window.location.hash.replace("#", "")
//           );
//           const email = session?.user?.email || urlParams.get("email") || "";
...
//         } else if (event === "SIGNED_IN" && currentScreen !== "resetPassword") {
//           // Chỉ chuyển hướng đến /home nếu không phải là luồng reset password
//           navigate("/home");
//         }
//       }
//     );

//     // Kiểm tra URL để xử lý thêm nếu cần
//     const urlParams = new URLSearchParams(
//       window.location.hash.replace("#", "")
//     );
...
//     if (type === "recovery") {
//       setCurrentScreen({ screen: "resetPassword", email: email || "" });
//     }
